...
CUDA_VISIBLE_DEVICES=0 python inference.py -m "/nfs1/yi.liu/src/so-vits-svc/logs/ljspeech_vctk_databaker_aishell3_mita_musha_jams_others_0607_contentvec/tuning_jams/G_315000.pth" \
