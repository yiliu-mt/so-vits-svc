...
data_config = {
    ...
    'cmvn_file': '/nfs1/zhenlin.liang/s0/conf/global_cmvn',
    'shuffle': False,
}
...
embedding_config = {
    'resume_asr_encoder_model': '/nfs1/vad/align_model/vocab162/6.pt',
    'use_layer_idx': 7
}
...
class ConformerPPGLarge(SpeechEncoder):
    def __init__(self, vec_path=None, device=None):
        ...
        vec_path = vec_path or embedding_config['resume_asr_encoder_model']
        load_checkpoint(embed_extractor, vec_path)
