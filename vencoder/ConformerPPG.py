...
embedding_config = {
    'resume_asr_encoder_model': '/nfs1/zhenlin.liang/conformer_embedding/pretrain_model/conformer_embedding_model.pt',
    'use_layer_idx': 11
}


class ConformerPPG(SpeechEncoder):
    def __init__(self, vec_path="pretrain/conformer_embedding_model.pt", device=None):
        if device is None:
